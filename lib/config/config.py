...
tf.app.flags.DEFINE_integer('batch_size', 1024, "Network batch size during training")
tf.app.flags.DEFINE_integer('max_iters', 5000, "Max iteration")
...
tf.app.flags.DEFINE_integer('snapshot_iterations', 500, "Iteration to take snapshot")
